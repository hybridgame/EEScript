...
* 전투시 시프나 샤먼으로 환상을 제거를 원하면 항상 함정 찾기를 선택하면 공격하지 않고 함정 찾기를 계속합니다. 환상이 제거되면 다시 비 전투시 함정 찾기로 전환하여 전투를 하면 됩니다.
...
| 샤먼                            | 비 전투시 함정 찾기 | 항상 샤먼의 춤                 | 항상 함정 찾기   |                  |
| 시프, 파/시, 메/시, 파/메/시    | 비 전투시 함정 찾기 | 적이 보이지 않으면 그림자 숨기 | 항상 함정 찾기   |                  |
| 클레릭/시프                     | 비 전투시 함정 찾기 | 적이 보이지 않으면 그림자 숨기 | 항상 함정 찾기   | 항상 언데드 퇴치 |
